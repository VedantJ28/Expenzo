...
export const Dashboard = ({user}) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-950 container mx-auto py-8">
      <h1 className="text-5xl dark:text-gray-200 text-gray-800 font-semibold text-center mb-8">Dashboard</h1>

      <div className="container mx-auto flex flex-col items-center lg:flex-row justify-center gap-8 mb-8 px-4 sm:px-8">
